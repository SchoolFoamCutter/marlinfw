...
#define STRING_CONFIG_H_AUTHOR "Foam Cutter team (dont sue us pls)" // Who made the changes.
 ...
 */
  ...
  #define TEMP_SENSOR_REDUNDANT_MAX_DIFF  100000000  // 10 (°C) Temperature difference that will trigger a print abort.
#endif
...
// #define PASSWORD_FEATURE
  ...
  #define PASSWORD_LENGTH 8                 // (#) Number of digits (1-9). 3 or 4 is recommended
